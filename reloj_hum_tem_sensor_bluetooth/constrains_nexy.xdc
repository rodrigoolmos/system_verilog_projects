...
##Switches
set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33} [get_ports arstn]
...
set_property -dict {PACKAGE_PIN N17 IOSTANDARD LVCMOS33} [get_ports key_mid]
set_property -dict {PACKAGE_PIN M18 IOSTANDARD LVCMOS33} [get_ports key_up]
set_property -dict {PACKAGE_PIN P17 IOSTANDARD LVCMOS33} [get_ports key_left]
set_property -dict {PACKAGE_PIN M17 IOSTANDARD LVCMOS33} [get_ports key_right]
set_property -dict {PACKAGE_PIN P18 IOSTANDARD LVCMOS33} [get_ports key_down]
...
##Pmod Header JA
set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { pwm_sig }]; #IO_L20N_T3_A19_15 Sch=ja[1]
...
set_property -dict {PACKAGE_PIN H4 IOSTANDARD LVCMOS33} [get_ports rx]
set_property -dict {PACKAGE_PIN H1 IOSTANDARD LVCMOS33} [get_ports tx];
set_property -dict {PACKAGE_PIN G1 IOSTANDARD LVCMOS33} [get_ports dht22_in_out]
set_property PULLUP TRUE [get_ports {dht22_in_out}]
